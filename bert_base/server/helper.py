...
def get_args_parser():
    ...
    group1.add_argument('-bert_model_dir', type=str,
                        default="D:\\LiuXianXian\\Pycharm--code\\BertServiceBase_classify\\checkpoints",
                        help='chinese google bert model path')

    group1.add_argument('-model_dir', type=str,
                        default="D:\\LiuXianXian\\Pycharm--code\\BertServiceBase_classify\\mypoints",
                        help='directory of a pretrained BERT model')
    group1.add_argument('-model_pb_dir', type=str,
                        default="D:\\LiuXianXian\\Pycharm--code\\BertServiceBase_classify\\mypoints",
                        help='directory of a pretrained BERT model')
    # group1.add_argument('-model_pb_dir', type=str,
    #                     help='directory of a pretrained BERT model')
    ...
    # group1.add_argument('-bert_model_dir', type=str,
    #                     default="/home/lxx/Bert_relation_extract/BertServiceBase_classify/checkpoints",
    #                     help='chinese google bert model path')
    #
    # group1.add_argument('-model_dir', type=str,
    #                     default="/home/lxx/Bert_relation_extract/BertServiceBase_classify/mypoints",
    #                     help='directory of a pretrained BERT model')
    # group1.add_argument('-model_pb_dir', type=str,
    #                     default="/home/lxx/Bert_relation_extract/BertServiceBase_classify/mypoints",
    #                     help='directory of a pretrained BERT model')
    ...
    group1.add_argument('-ckpt_name', type=str, default='model.ckpt-31000',
    ...
    parser.add_argument('-mode', type=str, default='CLASS')
